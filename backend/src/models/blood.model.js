...
bloodSchema.pre("save", function () {
  if (!this.bloodLab && !this.hospital) {
    throw new Error("Either bloodLab or hospital must be provided");
  }
  if (this.bloodLab && this.hospital) {
    throw new Error("Blood unit cannot belong to both bloodLab and hospital");
  }
});
