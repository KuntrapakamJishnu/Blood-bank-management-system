...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Simple and secure donor registration with OTP verification, medical history tracking, and eligibility checks.",
      color: "red",
    },
    {
      icon: Droplets,
    ...
    },
    {
      ...
      description:
        "Emergency request system with geolocation-based donor matching and alerts to reduce critical response time.",
      color: "green",
    },
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      icon: Search,
      title: "Find Match",
      description: "Our system finds compatible donors nearby using live geolocation",
    },
    {
      step: "03",
      icon: Bell,
