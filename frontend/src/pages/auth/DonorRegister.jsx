  ...
  const captureLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        toast.success("Location captured for faster donor matching");
        setGeoLoading(false);
      },
      () => {
        toast.error("Unable to fetch location. You can continue without it.");
        setGeoLoading(false);
      },
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  ...
                  />
                  <datalist id="donor-state-options">
                ...
                <div>
                  ...
                  />
                  <datalist id="donor-city-options">
                    {formData.address.state &&
                ...
                >
                  {geoLoading
                    ...
                    : geoLocation
                      ...
                      : "Use my current location for nearby matching"}
                </button>
              </div>
            </div>
          )}
