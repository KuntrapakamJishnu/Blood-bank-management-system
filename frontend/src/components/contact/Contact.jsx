        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 px-6">
          ...
          <div>
            ...
            <div className="flex gap-6 mt-8">
              <Heart className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
              <Bell className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
              <Shield className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
