...
import { Heart, MapPin, Phone, Mail, Globe, MessageSquare, Send, Shield } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              <div className="relative w-20 h-20 flex items-center justify-center rounded-3xl bg-gradient-to-br from-red-500 to-red-700 shadow-2xl p-2">
